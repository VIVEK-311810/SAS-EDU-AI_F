...
const AIResourceSearch = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">AI Resource Search</h1>
        <p className="text-gray-600">Search across all session materials using natural language</p>
      </div>
        ...
        <div className="mt-4 flex items-start gap-2 text-sm text-gray-600">
          ...
          <div>
            ...
            <ul className="mt-1 space-y-1">
              ...
              <li>"Explain polymorphism with examples"</li>
      ...
      {isSearching ? (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600">Searching through course materials...</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <p className="text-gray-600">Try rephrasing your question or using different keywords</p>
        </div>
      ) : results.length > 0 ? (
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">Query: "{query}"</span>
          </div>
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${getTypeColor(result.resource_type)}`}>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="text-blue-800 space-y-2 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>Ask questions in natural language - the AI understands context and meaning</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-500 font-bold">•</span>
              <span>Results are ranked by relevance to your question</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-500 font-bold">•</span>
              <span>Click on any result to open the full document at the relevant section</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-500 font-bold">•</span>
              <span>Search works across all PDF, Word, and PowerPoint files in this session</span>
            </li>
          </ul>
        </div>
      )}
